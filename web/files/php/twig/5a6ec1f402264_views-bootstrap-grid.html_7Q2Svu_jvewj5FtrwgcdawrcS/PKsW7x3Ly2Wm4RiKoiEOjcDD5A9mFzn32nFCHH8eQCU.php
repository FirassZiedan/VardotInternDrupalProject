  ...
  ";
        ...
        ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                    // line 26
                    echo "          <div class=\"col ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["col_xs"]) ? $context["col_xs"] : null), "html", null, true));
                    echo " ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["col_sm"]) ? $context["col_sm"] : null), "html", null, true));
                    echo " ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["col_md"]) ? $context["col_md"] : null), "html", null, true));
                    echo " ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["col_lg"]) ? $context["col_lg"] : null), "html", null, true));
                    echo " ";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["options"]) ? $context["options"] : null), "row_class", array()), "html", null, true));
                    echo "\">
            ";
                    // line 27
...
";
    ...
    {
        return new Twig_Source("", "modules/contrib/views_bootstrap/templates/views-bootstrap-grid.html.twig", "/var/aegir/projects/firass/dev/web/modules/contrib/views_bootstrap/templates/views-bootstrap-grid.html.twig");
    }
}
