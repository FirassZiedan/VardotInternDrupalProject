...
class __TwigTemplate_e122ee9ba31253dc04586176f4992d7986c95bfb1bf53e1cde4b7dc0013f3cd1 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 15
        echo "<div id=\"";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["uniqueid"]) ? $context["uniqueid"] : null), "html", null, true));
        echo "\" class=\"geolocation-formatter-map-wrapper\" ";
        if ( !twig_test_empty((isset($context["latitude"]) ? $context["latitude"] : null))) {
            echo " data-map-lat=\"";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["latitude"]) ? $context["latitude"] : null), "html", null, true));
            echo "\" ";
        }
        echo " ";
        if ( !twig_test_empty((isset($context["longitude"]) ? $context["longitude"] : null))) {
            echo " data-map-lng=\"";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["longitude"]) ? $context["longitude"] : null), "html", null, true));
            echo "\" ";
        }
        echo ">
...
";
    ...
    {
        return new Twig_Source("", "modules/contrib/geolocation/templates/geolocation-map-formatter.html.twig", "/var/aegir/projects/firass/dev/web/modules/contrib/geolocation/templates/geolocation-map-formatter.html.twig");
    }
}
