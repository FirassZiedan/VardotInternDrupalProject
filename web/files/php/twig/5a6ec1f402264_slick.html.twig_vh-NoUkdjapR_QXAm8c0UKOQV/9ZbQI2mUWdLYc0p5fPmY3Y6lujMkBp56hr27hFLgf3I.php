...
<div";
  ...
  ";
        ...
        if ( !$this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "unslick", array())) {
            // line 59
            echo "    <div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["content_attributes"]) ? $context["content_attributes"] : null), "addClass", array(0 => "slick__slider"), "method"), "html", null, true));
            echo ">
  ";
        }
        // line 61
...
";
    ...
    public function block_slick_arrow($context, array $blocks = array())
    {
        // line 71
        echo "      <nav";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["arrow_attributes"]) ? $context["arrow_attributes"] : null), "addClass", array(0 => (isset($context["arrow_classes"]) ? $context["arrow_classes"] : null)), "method"), "html", null, true));
        echo ">
        ";
        // line 72
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(strip_tags($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "prevArrow", array()), "<a><em><span><strong><button><div>")));
        echo "
        ";
        // line 73
        if (array_key_exists("arrow_down_attributes", $context)) {
            // line 74
            echo "          <button";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["arrow_down_attributes"]) ? $context["arrow_down_attributes"] : null), "addClass", array(0 => "slick-down"), "method"), "setAttribute", array(0 => "type", 1 => "button"), "method"), "setAttribute", array(0 => "data-target", 1 => $this->getAttribute(            // line 76
...
(isset($context["settings"]) ? $context["settings"] : null), "downArrowOffset", array())), "method"), "html", null, true));
        ...
        // line 79
        echo "        ";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(strip_tags($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "nextArrow", array()), "<a><em><span><strong><button><div>")));
        echo "
      </nav>
    ";
    }
    ...
    {
        return new Twig_Source("", "modules/contrib/slick/templates/slick.html.twig", "/var/aegir/projects/firass/dev/web/modules/contrib/slick/templates/slick.html.twig");
    }
}
