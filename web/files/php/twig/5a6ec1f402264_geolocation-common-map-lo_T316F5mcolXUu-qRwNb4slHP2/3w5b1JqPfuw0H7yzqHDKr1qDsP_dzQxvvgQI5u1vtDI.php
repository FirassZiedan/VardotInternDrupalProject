...
class __TwigTemplate_016c79fb743e8d93a1d8d09a802261721ebbbae30482c2e3319c417d94ca5cd2 extends Twig_Template
{
    ...
    data-lat=\"";
        // line 12
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["position"]) ? $context["position"] : null), "lat", array()), "html", null, true));
        echo "\"
    data-lng=\"";
        // line 13
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["position"]) ? $context["position"] : null), "lng", array()), "html", null, true));
        echo "\"
    typeof=\"Place\"
    ";
        // line 15
        if ( !twig_test_empty((isset($context["location_id"]) ? $context["location_id"] : null))) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["location_id"]) ? $context["location_id"] : null), "html", null, true));
            echo "\" ";
        }
        // line 16
        echo "    ";
        ...
        ";
            ...
            if ( !twig_test_empty((isset($context["marker_label"]) ? $context["marker_label"] : null))) {
                ...
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["marker_label"]) ? $context["marker_label"] : null), "html", null, true));
                echo "\" ";
            }
            // line 20
            echo "    ";
    ...
    {
        return new Twig_Source("", "modules/contrib/geolocation/templates/geolocation-common-map-location.html.twig", "/var/aegir/projects/firass/dev/web/modules/contrib/geolocation/templates/geolocation-common-map-location.html.twig");
    }
}
