...
/* themes/custom/mouse/templates/menu/menu.html.twig */
class __TwigTemplate_2a1f9b861d7a010cbd33a5b41cc9ea09f059b8516718118fe9d1fd6f812bb9f1 extends Twig_Template
{
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 31
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "addClass", array(0 => "menu", 1 => "nav", 2 => ($context["menu_name"] ?? null)), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 33
...
$context["item"], "is_expanded", array()) && (($context["menu_level"] ?? null) == 0))) ? ("dropdown") : ("")), 2 => (($this->getAttribute(                    // line 40
$context["item"], "in_active_trail", array())) ? ("active") : ("")));
  ...
  ";
    ...
    {
        return "themes/custom/mouse/templates/menu/menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level, menu_name) %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/mouse/templates/menu/menu.html.twig", "/var/www/html/VardotInternDrupalProject/web/themes/custom/mouse/templates/menu/menu.html.twig");
    }
}
