...
";
        ...
        if ((isset($context["is_link"]) ? $context["is_link"] : null)) {
            // line 5
            echo "  ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getLink((isset($context["output"]) ? $context["output"] : null), (isset($context["entity_url"]) ? $context["entity_url"] : null)), "html", null, true));
            echo "
";
        } else {
            // line 7
...
{% endif %}", "{# inline_template_start #}{% if wrapper %}
<{{ wrapper }}{{ attributes }}>
{% endif %}
{% if is_link %}
  {{ link(output, entity_url) }}
