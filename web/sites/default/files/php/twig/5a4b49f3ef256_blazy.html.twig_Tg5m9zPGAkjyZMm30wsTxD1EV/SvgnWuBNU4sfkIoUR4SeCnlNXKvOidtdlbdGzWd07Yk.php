...
";
    ...
    ";
            // line 101
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["blazy"]) ? $context["blazy"] : null), "html", null, true));
            echo "
  </div>
";
        } else {
...
";
    ...
    public function block_blazy_player($context, array $blocks = array())
    {
        // line 48
        echo "      <iframe";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["iframe_attributes"]) ? $context["iframe_attributes"] : null), "addClass", array(0 => (isset($context["iframe_classes"]) ? $context["iframe_classes"] : null)), "method"), "html", null, true));
      ...
      ";
        ...
        <span class=\"media__icon media__icon--play\" data-url=\"";
            // line 51
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "autoplay_url", array()), "html", null, true));
            echo "\"></span>
      ";
        }
        // line 53
    ...
    public function block_blazy_media($context, array $blocks = array())
    {
      ...
      ";
        // line 61
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["player"]) ? $context["player"] : null), "html", null, true));
        echo "
      ";
        // line 62
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "icon", array()), "html", null, true));
        echo "
    </div>
  ";
    }
    ...
    public function block_blazy_content($context, array $blocks = array())
    {
        ...
        if ((isset($context["media_attributes"]) ? $context["media_attributes"] : null)) {
            echo "<div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["media_attributes"]) ? $context["media_attributes"] : null), "html", null, true));
            echo ">";
        }
        // line 70
        echo "      ";
        if (((isset($context["url"]) ? $context["url"] : null) &&  !$this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "player", array()))) {
            ...
            echo "\"";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["url_attributes"]) ? $context["url_attributes"] : null), "html", null, true));
            echo ">";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["media"]) ? $context["media"] : null), "html", null, true));
            echo "</a>
        ...
        ";
            ...
            if (((isset($context["captions"]) ? $context["captions"] : null) &&  !twig_test_empty($this->getAttribute((isset($context["captions"]) ? $context["captions"] : null), "lightbox", array())))) {
                ...
                // line 76
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["captions"]) ? $context["captions"] : null), "lightbox", array()), "html", null, true));
                // line 77
                echo "</div>
        ";
            }
    ...
    public function block_blazy_caption($context, array $blocks = array())
    {
        // line 88
        echo "      <div";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["caption_attributes"]) ? $context["caption_attributes"] : null), "html", null, true));
        echo ">
        ";
        // line 89
...
{% else %}
  {{ blazy }}
{% endif %}
", "modules/contrib/blazy/templates/blazy.html.twig", "/var/www/html/drupal/web/modules/contrib/blazy/templates/blazy.html.twig");
    }
}
