...
";
        // line 18
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["help_icon"]) ? $context["help_icon"] : null), "html", null, true));
        echo "
";
...
";
    ...
    {
        return new Twig_Source("", "modules/contrib/webform/templates/webform-element-help.html.twig", "/var/www/html/drupal/web/modules/contrib/webform/templates/webform-element-help.html.twig");
    }
}
